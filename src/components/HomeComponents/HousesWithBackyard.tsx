...
import { HouseLists } from "../constants/HousesWithBackYard";

const HousesWithBackyard = () => {
  return (
    <section className="container mx-auto my-20">
      <Heading title="Houses with backyard" />
...
export default HousesWithBackyard;
